...
save('H:\Transfer of carbon-tax revenue\Ans\iiasa_CUR_data.mat')
...
load('H:\Transfer of carbon-tax revenue\Ans\iiasa_CUR_data.mat')
enepro22= enepro*0;
...
save('H:\Transfer of carbon-tax revenue\Ans\fig2_iiasa_invREiiasa_sce_reg_finalenergy0424_CUR.mat','invREiiasa_sce_reg','-v7.3'); % million/y
save('H:\Transfer of carbon-tax revenue\Ans\fig2_iiasa_invREpath_sce_reg_finalenergy0424_CUR.mat','invREpath_sce_reg','-v7.3');

save('H:\Transfer of carbon-tax revenue\Ans\fig2_iiasa_invREpath_sce_noiiasa_finalenergy0424_CUR.mat','invREpath_sce','-v7.3');
save('H:\Transfer of carbon-tax revenue\Ans\fig2_iiasa_invREiiasa_sce_ori_finalenergy0424_CUR.mat','invREiiasa_sce_ori','-v7.3'); % million/y
save('H:\Transfer of carbon-tax revenue\Ans\fig2_iiasa_invREpath_sce_ori_finalenergy0424_CUR.mat','invREpath_sce_ori','-v7.3');
save('H:\Transfer of carbon-tax revenue\Ans\fig2_iiasa_invREiiasa_sce_finalenergy0424_CUR.mat','invREiiasa_sce','-v7.3'); % million/y
save('H:\Transfer of carbon-tax revenue\Ans\fig2_iiasa_invREpath_sce_finalenergy0424_CUR.mat','invREpath_sce','-v7.3');
save('H:\Transfer of carbon-tax revenue\Ans\fig2_iiasa_co2path_sce_finalenergy0424_CUR.mat','co2path_sce','-v7.3');
save('H:\Transfer of carbon-tax revenue\Ans\fig2_iiasa_energyREpath_sce_finalenergy0424_CUR.mat','energyREpath_sce','-v7.3');
save('H:\Transfer of carbon-tax revenue\Ans\fig2_iiasa_energyALLpath_sce_finalenergy0424_CUR.mat','energyALLpath_sce','-v7.3');
energyREpath_sce_iiasa = (reshape(sum(sum(enepro22(2:12,1:7,:,4:9),1),4),[7,1291]))'/3.6;
save('H:\Transfer of carbon-tax revenue\Ans\fig2_iiasa_energyREpath_sce_iiasa_finalenergy0424_CUR.mat','energyREpath_sce_iiasa','-v7.3');