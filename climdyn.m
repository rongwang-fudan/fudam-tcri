...
function clim2  =  climdyn( t1, clim1, IE, rff )
...
global  Fex deltarf FFlux tip_para tip_threshold clim0
%   realtime:  time
...
%Total emission to atmosphere = industrial emission Gt C + land use change emissions GtC
E = (IE/3.666+Fex0(1,5))*tstep;
...
%     if clim1(1,tip_i+11)>tip_threshold
    if clim2(8)>tip_para(tip_i,1) || clim1(1,tip_i+27)>0
        ...
        if (t1-clim2(1,tip_i+27))<=tip_para(tip_i,4)
            ...
            if tip_i==11 && clim2(8)>1.5
                clim2(44) = clim2(44) + 4 * (clim2(8)-1.5); % 2 Gt C/yr for 2 C
            end
