...
1.5	1	3	2000	0.05	0	0.1	0.02372
1.8	1.1	3.8	20	-0.5	0	0.05	0.01482
...
% clim2 = calib_csi ( clim0, land_csink, ocean_csink );
% clim00=zeros(117,11);
% prtp0=0.02;
% for i=1:13
%     for j=1:9
%         clim00((i-1)*9+j,1:11) = calib_csi ( clim0, 2.4+i/10, 2.1+j/10 );
%     end
% end
% save('inputs\calib_csi_clim0.dat','clim00');
load('inputs\calib_csi_clim0.dat','-mat');
clim0=clim00(59,1:11);
